...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { apellidos: @estudiante.apellidos, carnet: @estudiante.carnet, carrera: @estudiante.carrera, nacimiento: @estudiante.nacimiento, nombres: @estudiante.nombres, telefono: @estudiante.telefono } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { apellidos: @estudiante.apellidos, carnet: @estudiante.carnet, carrera: @estudiante.carrera, nacimiento: @estudiante.nacimiento, nombres: @estudiante.nombres, telefono: @estudiante.telefono } }
